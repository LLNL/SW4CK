...
return
  ...
  // #pragma ivdep
          ...
          r1 += i6 *
                (mux1 * (su1[TX][TY2][TZ2] - su1[TX2][TY2][TZ2]) +
                 mux2 * (su1[TX+1][TY2][TZ2] - su1[TX2][TY2][TZ2]) +
                 mux3 * (su1[TX2+1][TY2][TZ2] - su1[TX2][TY2][TZ2]) +
                 mux4 * (su1[TX2+2][TY2][TZ2] - su1[TX2][TY2][TZ2])) *
                istry;
          // qq derivative (u)
          // 43 ops, tot=101
          {
            ...
            r1 += i6 *
                  (mux1 * (su1[TX2][TY][TZ2] - su1[TX2][TY2][TZ2]) +
                   mux2 * (su1[TX2][TY+1][TZ2] - su1[TX2][TY2][TZ2]) +
                   mux3 * (su1[TX2][TY2+1][TZ2] - su1[TX2][TY2][TZ2]) +
                   mux4 * (su1[TX2][TY2+2][TZ2] - su1[TX2][TY2][TZ2])) *
                  istrx;
          }
          // rr derivative (u)
          // 5*11+14+14=83 ops, tot=184
          {
            ...
            r1 += i6 *
                  (mux1 * (su1[TX2][TY2][TZ] - su1[TX2][TY2][TZ2]) +
                   mux2 * (su1[TX2][TY2][TZ+1]- su1[TX2][TY2][TZ2]) +
                   mux3 * (su1[TX2][TY2][TZ2+1] - su1[TX2][TY2][TZ2]) +
                   mux4 * (su1[TX2][TY2][TZ2+2] - su1[TX2][TY2][TZ2])) *
                  istrxy;
          }
          // rr derivative (v)
          // 42 ops, tot=226
          ...
          r1 +=
              c2 *
                  ((2 * mu(i, j, k + 2) + la(i, j, k + 2)) *
                       ...
                       (c2 * (su1[TX2+2][TY2][TZ2+2] - su1[TX][TY2][TZ2+2]) +
                        c1 * (su1[TX2+1][TY2][TZ2+2] - su1[TX+1][TY2][TZ2+2])) *
                       strx(i) * istry +
                   ...
                   ((2 * mu(i, j, k - 2) + la(i, j, k - 2)) *
                        met(2, i, j, k - 2) * met(1, i, j, k - 2) *
                        (c2 * (su1[TX2+2][TY2][TZ]  - su1[TX][TY2][TZ]) +
                         c1 * (su1[TX2+1][TY2][TZ] - su1[TX+1][TY2][TZ])) *
                        strx(i) * istry +
              ...
              c1 *
                  ((2 * mu(i, j, k + 1) + la(i, j, k + 1)) *
                       ...
                       (c2 * (su1[TX2+2][TY2][TZ2+1] - su1[TX][TY2][TZ2+1]) +
                        c1 * (su1[TX2+1][TY2][TZ2+1] - su1[TX+1][TY2][TZ2+1])) *
                       strx(i) * istry +
                   ...
                   ((2 * mu(i, j, k - 1) + la(i, j, k - 1)) *
                        met(2, i, j, k - 1) * met(1, i, j, k - 1) *
                        (c2 * (su1[TX2+2][TY2][TZ+1] - su1[TX][TY2][TZ+1] ) +
                         c1 * (su1[TX2+1][TY2][TZ+1] - su1[TX+1][TY2][TZ+1] )) *
                        strx(i) * istry +
